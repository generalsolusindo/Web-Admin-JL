...
<body>
    <div class="">
        @for ($i = 0; $i < 3; $i++)
            <div class="bg-white font-medium px-12 md:px-12 sm:px-8 xs:px-4 py-4 text-sm h-44 sm:h-48 xs:h-48 my-3">
                <span class="inline-block md:inline-block sm:hidden xs:hidden">Top Up Saldo OVO</span>
                <span class="inline-block lg:hidden md:hidden">T.U Saldo OVO</span>
                ...
                <div class="border-t-2 my-3 pt-2">
                    <div class="grid grid-cols-3">
                        <div class="col-start-1 col-end-3 border-r-2 border-gray-300">
                            <span class="text-md font-semibold">Pembelian Saldo OVO</span>
                            <p class="mt-1 font-normal ">089525001655</p>
                        </div>
                        <div class="ml-3 mt-3">
                ...
                <div class="mt-4 sm:text-sm xs:text-xs flex mx-auto justify-end">
                    ...
                    <a href="" data-te-toggle="modal" data-te-target="#Detail_saldo_ovo" data-te-ripple-init
    ...
    <div data-te-modal-init
        ...
        id="Detail_saldo_ovo" tabindex="-1" aria-labelledby="detail-transaksi" aria-hidden="true">
                ...
                <div class="relative flex-auto p-4" data-te-modal-body-ref>
                    <div class="border-b-2 pb-4 text-sm sm:text-sm xs:text-xs">
                        ...
                        <div class="pt-2 grid grid-cols-2">
                            ...
                            <span class="ml-2 font-medium">Saldo OVO 15000 </span>
                        </div>
                    </div>
                    <div class="py-2 text-sm sm:text-sm xs:text-xs">
                        ...
                        <div class="pt-2 grid grid-cols-2">
                            ...
                            <span class="ml-2 font-medium">089525001655</span>
                        </div>
                        <div class="pt-2 grid grid-cols-2">
                        ...
                        <div class="pt-2 grid grid-cols-2">
                            <span>Harga</span>
                            <span class="ml-2 font-medium">Rp15000</span>
                        </div>
                        <div class="pt-2 grid grid-cols-2">
                            <span>3 Digit Angka Unik</span>
                            <span class="ml-2 font-medium">523</span>
                        </div>
                        <div class="pt-2 grid grid-cols-2">
                        ...
                        <div class="pt-2 grid grid-cols-2">
                            ...
                            <span class="ml-2 font-medium">Rp15.523</span>
                        </div>
                    </div>
