...
<body class="bg-gray-200">
    ...
    <div class="pt-16">
        <div class="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col justify-between mx-auto max-w-screen-xl lg:max-w-screen-xl md:max-w-screen-sm sm:max-w-screen-xs xs:max-w-screen-xs py-2.5">
            <div class="w-full h-48 md:h-52 sm:h-full xs:h-full bg-white border border-gray-300 rounded-lg shadow mr-4 lg:mb-0 md:mb-5 sm:mb-8 xs:mb-9">
                <div class="border-b-4">
                    <h5 class="px-12 lg:px-12 md:px-10 sm:px-8 xs:px-5 py-4 text-xl lg:text-xl md:text-lg sm:text-md xs:text-sm font-bold text-gray-900 ">Checkout Tagihan PLN</h5>
                </div>
                <div class="px-12 lg:px-12 md:px-10 sm:px-8 xs:px-5 text-sm xs:text-xs py-2">
                    <div class="grid grid-cols-2 leading-7 gap-8">
                        <div>Jenis Layanan</div>
                        <div>Tagihan Listrik</div>
                    </div>
                    <div class="grid grid-cols-2 leading-7 gap-8">
                        <div>No Meter/ID Pelanggan</div>
                        <div class="xs:pt-2">123456789101</div>
                    </div>
                    <div class="grid grid-cols-2 leading-7 gap-8">
                        <div>Nominal Tagihan</div>
                        <div>Rp50.000</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="px-8 text-sm font-medium ">
                        ...
                        <div class="my-2 border-t-2 grid grid-cols-2 py-4">
                            ...
                            <span class="text-right text-xl font-bold">
                                Rp<?php echo number_format(20170); ?>
                            </span>
                        </div>
                    </div>
                    <div class="px-8">
        ...
        <div data-te-modal-dialog-ref
            ...
            <div
                ...
                <div
                    ...
                    <h5 class="text-lg font-medium leading-normal text-neutral-800"
                        id="metode-pembayaranLabel">
                        Pilih Pembayaran
                    </h5>
                    <button type="button"
            ...
            <div
                ...
                <div class="relative flex-auto p-4" data-te-modal-body-ref>
                    ...
                    <div class="text-center my-6 ">
                        <span>Silahkan cek detail pada Riwayat Pembelian untuk melihat Transaksi Pembayaran Listrik Anda</span>
                    </div>
                </div>
