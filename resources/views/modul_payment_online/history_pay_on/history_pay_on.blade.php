...
<body class="bg-gray-200">
    ...
    <div class="pt-24 lg:pt-24 md:pt-12 sm:pt-10 xs:pt-8">
        <div
                    ...
                    <div class="sticky mb-5 flex flex-col lg:flex-row border-b-0 pl-0 overflow-x-scroll lg:overscroll-none hide-scroll-bar text-sm md:text-sm sm:text-xs xs:text-xs"
                        ...
                        <div class="flex flex-nowrap w-full">
                            <div role="presentation" class="flex-grow basis-0 text-center">
                                <a href="#pulsa"
                                    class="w-auto md:w-auto sm:w-auto xs:w-auto bg-white my-2 block border-x-0 border-t-0 border-b-4 border-transparent px-7 pt-4 pb-3.5 text-sm md:text-sm sm:text-xs xs:text-xs font-medium uppercase leading-tight text-neutral-500 hover:isolate hover:border-transparent hover:bg-neutral-50 focus:isolate focus:border-transparent data-[te-nav-active]:border-orange-juallagi_gelap data-[te-nav-active]:text-orange-juallagi_gelap"
                                    data-te-toggle="pill" data-te-target="#pulsa" data-te-nav-active role="tab"
                                    aria-controls="pulsa" aria-selected="true">Pulsa</a>
                            </div>
                            <div role="presentation" class="flex-grow basis-0 text-center ">
                                <a href="#paket-data"
                                    class="w-auto md:w-auto sm:w-36 xs:w-36 bg-white focus:border-transparen my-2 block border-x-0 border-t-0 border-b-4 border-transparent px-7 pt-4 pb-3.5 text-sm md:text-sm sm:text-xs xs:text-xs font-medium uppercase leading-tight text-neutral-500 hover:isolate hover:border-transparent hover:bg-neutral-50 focus:isolate data-[te-nav-active]:border-orange-juallagi_gelap data-[te-nav-active]:text-orange-juallagi_gelap"
                            ...
                            <div role="presentation" class="flex-grow basis-0 text-center">
                                <a href="#voucher-internet"
                                    class="w-auto md:w-auto sm:w-44 xs:w-44 bg-white my-2 block border-x-0 border-t-0 border-b-4 border-transparent px-7 pt-4 pb-3.5 text-sm md:text-sm sm:text-xs xs:text-xs font-medium uppercase leading-tight text-neutral-500 hover:isolate hover:border-transparent hover:bg-neutral-50 focus:isolate focus:border-transparent data-[te-nav-active]:border-orange-juallagi_gelap data-[te-nav-active]:text-orange-juallagi_gelap "
                            ...
                            <div role="presentation" class="flex-grow basis-0 text-center">
                                <a href="#games"
                                    class="w-auto md:w-auto sm:w-auto xs:w-auto bg-white focus:border-transparen my-2 block border-x-0 border-t-0 border-b-4 border-transparent px-7 pt-4 pb-3.5 text-sm md:text-sm sm:text-xs xs:text-xs font-medium uppercase leading-tight text-neutral-500 hover:isolate hover:border-transparent hover:bg-neutral-50 focus:isolate data-[te-nav-active]:border-orange-juallagi_gelap data-[te-nav-active]:text-orange-juallagi_gelap"
                                    data-te-toggle="pill" data-te-target="#games" role="tab" aria-controls="games"
                                    aria-selected="false">Games</a>
                            </div>
                            <div role="presentation" class="flex-grow basis-0 text-center">
                                <a href="#token-listrik"
                                    class="w-auto md:w-auto sm:w-36 xs:w-36 bg-white my-2 block border-x-0 border-t-0 border-b-4 border-transparent px-7 pt-4 pb-3.5 text-sm md:text-sm sm:text-xs xs:text-xs font-medium uppercase leading-tight text-neutral-500 hover:isolate hover:border-transparent hover:bg-neutral-50 focus:isolate focus:border-transparent data-[te-nav-active]:border-orange-juallagi_gelap data-[te-nav-active]:text-orange-juallagi_gelap "
