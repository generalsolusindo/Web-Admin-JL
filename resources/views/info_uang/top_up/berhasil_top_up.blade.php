...
<body>
    <div class="">
        @for ($i = 0; $i < 2; $i++)
            <div class="bg-white font-medium px-12 md:px-12 sm:px-8 xs:px-4 py-4 text-sm h-44 sm:h-44 xs:h-44 my-3">
                ...
                <span class=" font-normal">23 Maret 2023</span>
                <span class="ml-2 bg-green-success px-2 py-1 rounded-lg text-xs text-white"><span class="md:inline-block sm:hidden xs:hidden">Top Up</span> Berhasil</span>
                <span
                    class="ml-2 font-normal lg:inline-block md:inline-block sm:hidden xs:hidden">INV-202323030126459/VII/009870</span>
                ...
                <div class="mt-4 md:text-sm sm:text-xs xs:text-xs flex mx-auto justify-end">
                    ...
                    <a href="" data-te-toggle="modal" data-te-target="#detail_transaksi_topup"
    ...
    <!-- Modal Detail Transaksi Berhasil -->
    <div data-te-modal-init
        ...
        id="detail_transaksi_topup" tabindex="-1" aria-labelledby="detail-transaksi" aria-hidden="true">
                ...
                <div class="relative flex-auto p-4" data-te-modal-body-ref>
                    <div class="border-b-2 pb-4 text-sm sm:text-sm xs:text-xs">
                        ...
                        <div class="pt-2 grid grid-cols-2">
                            ...
                            <span
                                class="w-32 ml-2 font-medium bg-green-success px-3.5 py-1 rounded-lg text-white text-sm">Top
                                Up Berhasil</span>
                        </div>
                        <div class="pt-2 grid grid-cols-2">
