            ...
            <ul id="beli-pulsa" class=" flex flex-wrap text-sm font-medium sm:justify-start xs:justify-around">
                @foreach ($data as $result)
                    <li class="active:border-orange-juallagi_gelap m-2 pl-2 cursor-pointer">
                        <div
                            class="text-center h-16 w-32 p-4 rounded-lg border-2  hover:border-orange-juallagi_gelap transition ease-in-out hover:scale-105 delay-150 duration-200 ">
                            <span><?php echo number_format($result['nominal_pulsa']); ?></span>
