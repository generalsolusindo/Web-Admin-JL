...
<body class="bg-gray-200">
    ...
    <div class="pt-16">
        <div class="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col justify-between mx-auto max-w-screen-xl lg:max-w-screen-xl md:max-w-screen-sm sm:max-w-screen-xs xs:max-w-screen-xs py-2.5">
            <div class="w-full h-64 lg:h-64 md:h-full sm:h-full xs:h-full bg-white border border-gray-300 rounded-lg shadow mr-4 lg:mb-0 md:mb-5 sm:mb-8 xs:mb-9">
                <div class="border-b-4">
                    <h5 class="px-12 lg:px-12 md:px-10 sm:px-8 xs:px-5 lg:text-xl md:text-lg sm:text-md xs:text-sm py-4 text-xl font-bold text-gray-900 ">Checkout Top Up Game</h5>
                </div>
                <div class="px-12 lg:px-12 md:px-10 sm:px-8 xs:px-5 text-sm xs:text-xs py-2">
                    <div class="grid grid-cols-2 leading-7">
                        ...
                        <div>Pembelian Voucher Game Call Of Duty 317 CP </div>
                    </div>
                    <div class="grid grid-cols-2 leading-7">
                        <div>Nama Game</div>
                    ...
                    <div class="grid grid-cols-2 leading-7">
                        <div>Top Up</div>
                        <div>Call Of Duty 317 CP </div>
                    </div>
                    <div class="grid grid-cols-2 leading-7">
                        <div>Nominal Pembelian</div>
                        <div>Rp<?php echo number_format(48480); ?></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="px-8 text-sm font-medium ">
                        <div class="grid grid-cols-2 py-2">
                            ...
                            <span class="text-right">
                                Rp<?php echo number_format(48480); ?>
                            </span>
                        </div>
                        ...
                        <div class="my-2 border-t-2 grid grid-cols-2 py-4">
                            ...
                            <span class="text-right text-xl font-bold">
                                Rp<?php echo number_format(11849); ?>
                            </span>
                        </div>
                    </div>
                    <div class="px-8">
            ...
            <div
                ...
                <div class="relative flex-auto p-4" data-te-modal-body-ref>
                    ...
                    <div class="text-center my-6 ">
                        <span>Silahkan cek detail pada Riwayat Pembelian untuk melihat Transaksi Top Up Game Anda</span>
                    </div>
                </div>
