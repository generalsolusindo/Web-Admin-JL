...
<body>
    <div class="">
        @for ($i = 0; $i < 3; $i++)
            <div class="bg-white font-medium px-12 md:px-12 sm:px-8 xs:px-4 py-4 text-sm h-44 sm:h-44 xs:h-44 my-3">
                <span class="">Voucher Internet</span>
                ...
                <div class="border-t-2 my-3 pt-2 pr-2">
                    <div class="grid grid-cols-3">
                        <div class="col-start-1 col-end-3 border-r-2 border-gray-300">
                            <span class="text-md font-semibold">Pembelian Voucher Internet Tri</span>
                ...
                <div class=" mt-4 sm:text-sm xs:text-xs flex mx-auto justify-end">
                    ...
                    <a href="" data-te-toggle="modal" data-te-target="#Detail_transaksi_voucherIn" data-te-ripple-init
                        data-te-ripple-color="light"
                        class="mr-2 bg-orange-juallagi_gelap p-2 rounded-lg text-white">Lihat Detail Transaksi</a>
                    <button class="bg-green-success text-right p-2 text-white rounded-lg">
                        <span>Beli Lagi</span>
                    </button>
                </div>
            </div>
    ...
    <div data-te-modal-init
        ...
        id="Detail_transaksi_voucherIn" tabindex="-1" aria-labelledby="detail-transaksi" aria-hidden="true">
                ...
                <div class="relative flex-auto p-4" data-te-modal-body-ref>
                    <div class="border-b-2 pb-4 text-sm sm:text-sm xs:text-xs">
                        ...
                        <div class="pt-2 grid grid-cols-2">
                            ...
                            <span class="ml-2 font-medium">Voucher Internet </span>
                        </div>
                    </div>
                    <div class="py-2 text-sm sm:text-sm xs:text-xs">
                        ...
                        <div class="pt-2 grid grid-cols-2">
                            ...
                            <span class="ml-2 font-medium">Tri Home 117</span>
                        </div>
                        <div class="pt-2 grid grid-cols-2">
                            <span>Harga</span>
                        ...
                        <div class="pt-2 grid grid-cols-2">
                            ...
                            <span class="ml-2 font-medium">946</span>
                        </div>
                        <div class="pt-2 grid grid-cols-2">
                        ...
                        <div class="pt-2 grid grid-cols-2">
                            ...
                            <span class="ml-2 font-medium">Rp15.946</span>
                        </div>
                    </div>
