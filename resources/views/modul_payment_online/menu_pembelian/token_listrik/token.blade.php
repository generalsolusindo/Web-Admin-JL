...
<body>
    <div class="mx-auto max-w-screen-lg px-4 md:px-6 py-2.5 bg-white">
        <span class=" text-xl font-bold font-sans my-2">Token Listrik</span>
        <div class="mb-4">
            <span class="text-sm text-gray-400">Nomor Meter/Id Pel <button data-popover-target="information-pulsa"
        ...
        <div class="relative z-0 w-full mb-6 group">
            ...
            <label for="floating_email"
                ...
                No. Meter/Id Pel</label>
        </div>
        <div class="">
            <ul class="flex flex-wrap text-sm font-medium">
                @foreach ($data as $items)
                    <li class="mr-2 my-2 lg:mr-2 xs:mr-1">
                        <a href="">
                            <div
                                class="text-center h-20 w-28 lg:w-28 sm:w-24 xs:w-24 border-2 border-gray-200 hover:border-orange-juallagi_gelap transition ease-in-out hover:scale-105 delay-150 duration-200">
                                <div class="pt-4">
                                    <span><?php echo $items['nama_token']?></span>
                                    <p class="text-sm font-medium">Rp<?php echo $items['harga_token']?></p>
                                </div>
                            </div>
                        </a>
                    </li>
