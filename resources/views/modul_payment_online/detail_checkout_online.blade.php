...
<body class="bg-gray-200">
    ...
    <div class="pt-16">
        <div class="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col justify-between mx-auto max-w-screen-xl lg:max-w-screen-xl md:max-w-screen-sm sm:max-w-screen-xs xs:max-w-screen-xs py-2.5">
            <div class="w-full h-52 md:h-52 sm:h-full xs:h-full bg-white border border-gray-300 rounded-lg shadow mr-4 lg:mb-0 md:mb-5 sm:mb-8 xs:mb-9">
                <div class="border-b-4">
                    <h5 class="lg:px-12 md:px-10 sm:px-8 xs:px-5 py-4 text-xl lg:text-xl md:text-lg sm:text-md xs:text-sm font-bold text-gray-900 ">Checkout</h5>
                </div>
                <div class="px-12 lg:px-12 md:px-10 sm:px-8 xs:px-5 text-sm xs:text-xs py-2">
                    ...
                    <div class="grid grid-cols-2 leading-7">
                        ...
                        <div>085731544494</div>
                    </div>
                    <div class="grid grid-cols-2 leading-7">
                        <div>Nominal Pembelian</div>
                        <div><?php echo number_format(50000); ?></div>
                    </div>
                </div>
            </div>
    ...
    <div data-te-modal-init
        class="fixed top-0 lg:top-0 md:top-0 sm:top-10 xs:top-10 sm:px-0 xs:px-10 left-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none"
        id="modal-bayar" tabindex="-1" aria-labelledby="modal-bayarLabel" aria-hidden="true">
        <div data-te-modal-dialog-ref
            class="pointer-events-none relative w-auto translate-y-[-50px] opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:max-w-[500px]">
            <div
                class="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none">
                <div class="relative flex-auto p-4" data-te-modal-body-ref>
                    ...
                    <div class="text-center my-6 ">
                        <span>Silahkan cek detail pada Riwayat Pembelian untuk melihat Transaksi Pembelian Anda</span>
                    </div>
                </div>
