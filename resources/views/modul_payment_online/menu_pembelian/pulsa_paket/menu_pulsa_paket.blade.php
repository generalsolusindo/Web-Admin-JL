        ...
        <ul class="bg-transparant mb-5 flex list-none flex-col flex-wrap border-b-0 pl-0 md:flex-row sm:flex-row xs:flex-row" role="tablist" data-te-nav-ref>
            <li role="presentation" class="flex-grow basis-0 text-center bg-white">
                <a href="#tabs-pulsa"
                    ...
                    aria-controls="tabs-pulsa" aria-selected="true">Pulsa</a>
            </li>
            <li role="presentation" class="flex-grow basis-0 text-center bg-white">
                <a href="#tabs-paket-data"
                    ...
                    aria-controls="tabs-paket-data" aria-selected="false">Paket Data</a>
            </li>
        </ul>
        <div class="mb-6">
            <div class="hidden opacity-100 transition-opacity duration-150 ease-linear data-[te-tab-active]:block"
                id="tabs-pulsa" role="tabpanel" aria-labelledby="tabs-home-tab02" data-te-tab-active>
                @include('modul_payment_online.menu_pembelian.pulsa_paket.menu_pulsa')
            </div>
            <div class="hidden opacity-0 transition-opacity duration-150 ease-linear data-[te-tab-active]:block"
                id="tabs-paket-data" role="tabpanel" aria-labelledby="tabs-profile-tab02">
                @include('modul_payment_online.menu_pembelian.pulsa_paket.menu_paket_data') 
            </div>
        </div>
    </div>
        <div class="mt-10">
